...
<div class="rh-wrap bg-light pb-5" style="margin: -2rem; padding: 2rem;">

    {{-- ===== HERO ===== --}}
    {{-- Menggunakan background image dari halaman product dan layout hero yang senada --}}
        ...
        <div class="position-relative z-1">
            ...
            <div class="search-box mx-auto d-flex flex-wrap align-items-center gap-2 shadow-lg">
                <div class="flex-grow-1 px-2 text-start">
                    ...
                    <input type="text" class="form-control border-0 shadow-none px-0" placeholder="Kota, bandara, atau alamat" style="min-width:140px; background: transparent;">
                </div>
                ...
                <div class="border-start px-3 text-start">
                    <label class="text-muted d-block" style="font-size:0.7rem; font-weight:700; text-transform:uppercase;">📅 Dari</label>
                    <input type="date" class="form-control border-0 shadow-none px-0" style="min-width:130px; background: transparent;">
                </div>
                <div class="border-start px-3 text-start">
                    <label class="text-muted d-block" style="font-size:0.7rem; font-weight:700; text-transform:uppercase;">📅 Sampai</label>
                    <input type="date" class="form-control border-0 shadow-none px-0" style="min-width:130px; background: transparent;">
                </div>
    ...
    <div class="container-fluid px-0">
        ...
        <div class="row g-3 mb-5">
            <div class="col-6 col-md-3">
                <div class="card feature-card shadow-sm border-0 h-100 text-center p-3">
                    <div class="fs-2 fw-bold text-primary mb-1">{{ $cars->count() }}+</div>
        ...
        {{-- Filter Tipe (Mengikuti gaya btn-dark dari halaman Product) --}}
        ...
        {{-- Grid Mobil (Desain disamakan dengan Product) --}}
        ...
        {{-- ===== CARA BOOKING & KEUNGGULAN (Disatukan gaya form payment) ===== --}}
