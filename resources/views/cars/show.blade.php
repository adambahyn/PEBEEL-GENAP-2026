        ...
        <div class="row g-0">
            ...
            <div class="col-md-6 p-4">
                ...
                <div class="price mb-3">
                    Rp {{ number_format($car->price) }} / hari
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div>{{ $car->provider_name }}</div>
                    </div>

                    <div class="col-6">
                        <div class="info-label">Kontak</div>
                        <div>{{ $car->provider_contact }}</div>
                    </div>
                </div>

                <!-- BUTTON -->
                <div class="mt-4">
                    <a href="{{ route('payment.index') }}" class="btn btn-primary w-100">
                        Booking Sekarang
                    </a>
                </div>
